...
for i in range(1, NUM_ORDERS + 1):
    ...
    orders.append({
        ...
        'ShippingCost_EUR': round(random.uniform(3.50, 7.50), 2),
...
print("- Dim_Customers.csv (Anonymized for DSGVO)")
print("- Fact_Orders.csv (Contains engineered logistics delays and returns)")